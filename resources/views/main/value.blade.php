            ...
            <div class="container"><br><br>
                ...
                <div class="row text-center my-3">
                    ...
                    <div class="col-md-4 my-3">
                        ...
                        <h3 class="my-3"style="font-family: josefin;font-weight: 700;color: #4D4D4F;">
                            Professionalism</h3>
                        <h5 style="font-weight: 400;color: #4D4D4F; font-family:josefin;">Proactive, committed,</h5>
                    ...
                    <div class="col-md-4 my-3">
                        ...
                        <h3 class="my-3"style="font-family: josefin;font-weight: 700;color: #4D4D4F;">
                            High-Tech</h3>
                        <h5 style="font-weight: 400;color: #4D4D4F; font-family:josefin;">Always working the</h5>
                        <h5 style="font-weight: 400;color: #4D4D4F; font-family:josefin;">possibilities. </h5>
                    </div>
                </div>
                <br>
                <div class="square">
